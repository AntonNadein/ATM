...
class TestCheckPin(unittest.TestCase):
    @patch(
        "builtins.input", side_effect=["нет", 12, "нет", 12, "нет", 12]
    )
    ...
    @patch(
        "builtins.input", side_effect=["нет", 12, "нет", 12, "нет", 1]
    )
    ...
    @patch(
        "builtins.input", side_effect=["нет", 1]
    )
